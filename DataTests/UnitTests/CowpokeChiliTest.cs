...
namespace CowboyCafe.DataTests
{
    public class CowpokeChiliTest
    {
        ...
        {
            var chili = new AngryChicken();
            Assert.IsAssignableFrom<INotifyPropertyChanged>(chili);
        }

        [Fact]
        public void ChangingTortillaPropertyShouldInvokePropertyChangedForTortilla()
        {
            var chili = new CowpokeChili();
        ...
        [Fact]
        public void ChangingGreenOnionPropertyShouldInvokePropertyChangedForGreenOnion()
        {
            var chili = new CowpokeChili();
